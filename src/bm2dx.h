...
namespace bm2dx
{
    ...
    }; static_assert(sizeof(mdb_common) == 0x8);

    struct mdb_v27: mdb_common
    {
    ...
    }; static_assert(sizeof(mdb_v27) == 0x10);

    struct mdb_v32: mdb_common
    {
        ...
        auto static constexpr is_supported(auto version) -> bool
            { return version >= 32 && version <= 34; }

        /* 0x0008 */ std::int32_t entries;
        /* 0x000C */ std::int32_t max_entries;
    }; static_assert(sizeof(mdb_v32) == 0x10);
}